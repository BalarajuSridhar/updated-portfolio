document.addEventListener('DOMContentLoaded', function () {
    ...
    const resumeData = {
        experience: [
            { date: "2023 - Present", company: "Tech Innovations Inc.", position: "Frontend Developer", description: "Developed responsive web applications using React and Next.js. Improved page load performance by 40% through code optimization." },
            { date: "2021 - 2023", company: "Digital Solutions LLC", position: "UI Developer Intern", description: "Collaborated with designers to implement pixel-perfect interfaces. Built reusable component library." }
        ],
        education: [
            { date: "2020 - 2024", company: "University of Computer Science", position: "B.S. in Computer Science", description: "Specialized in Web Technologies. GPA: 3.8/4.0" },
            { date: "2018 - 2020", company: "Tech High School", position: "Advanced Diploma", description: "Focus on Mathematics and Programming" }
        ],
        skills: [
            { category: "Frontend", skills: [{ name: "React", level: 90 }, { name: "JavaScript", level: 85 }, { name: "HTML/CSS", level: 95 }] },
            { category: "Backend", skills: [{ name: "Node.js", level: 80 }, { name: "Python", level: 75 }] }
        ]
    };

    const projectsData = [
        { image: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?q=80&w=2070&auto=format&fit=crop', title: 'Login Page', description: 'My first project - a clean, responsive login page with form validation built with pure HTML, CSS and JavaScript.', tech: ['HTML', 'CSS', 'JavaScript'], liveLink: 'https://balarajusridhar.github.io/login-page', sourceLink: 'https://github.com/Balarajusridhar/login-page' },
        { image: 'https://images.unsplash.com/photo-1505751172876-fa1923c5c528?q=80&w=2070&auto=format&fit=crop', title: 'Health Record App', description: 'A Streamlit application for managing health records with data visualization and user authentication.', tech: ['Python', 'Streamlit', 'Pandas'], liveLink: 'https://health-record-app-6nwxneejigktocojpwdtkg.streamlit.app/', sourceLink: 'https://github.com/Balarajusridhar/health-record-app' },
        { image: 'https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?q=80&w=2070&auto=format&fit=crop', title: 'Portfolio Website', description: 'A responsive personal portfolio website showcasing my skills and projects with modern design.', tech: ['HTML', 'CSS', 'JavaScript'], liveLink: 'https://balarajusridhar.github.io/updated-portfolio', sourceLink: 'https://github.com/Balarajusridhar/updated-portfolio' }
    ];
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-200 flex justify-between items-center">
                            <div class="flex space-x-4">
                                <a href="${project.liveLink}" target="_blank" class="font-bold hover:underline text-green-600">Live Demo</a>
                                <a href="${project.sourceLink}" target="_blank" class="font-bold hover:underline text-green-600">Source Code</a>
                            </div>
    ...
    if (resumeSection) {
        ...
        function loadResumeContent(type) {
            ...
            if (type === 'experience' || type === 'education') {
                ...
                html = resumeData.skills.map(category => `
                    <h3 class="resume-skill-category">${category.category}</h3>
    ...
    projectsGrid.addEventListener('click', async function (e) {
        if (e.target && e.target.classList.contains('generate-desc-btn')) {
            ...
            try {
                ...
                generatedContent.innerText = "Couldn't generate description. Please try again later.";
            }
            showLoading(false);
        }
    });
    ...
    if(coverLetterBtn) {
        coverLetterBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                generatedContent.innerText = "Couldn't generate cover letter. Please try again later.";
            }
            showLoading(false);
        });
    }
    ...
    async function callGemini(prompt) {
        const apiUrl = '/generate-ai-content';
        try {
            ...
            console.error("Error calling your backend for AI content:", error);
